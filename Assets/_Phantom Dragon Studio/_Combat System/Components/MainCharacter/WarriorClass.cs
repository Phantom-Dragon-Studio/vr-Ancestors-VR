...
public class WarriorClass : CharacterClass
{
    protected override void ApplySecondaryGearBonuses()
    {
        ...
        _characterStats.characterData.criticalStrikeChance = _characterStats.characterData.baseAgility
            * _gameManager.GameSettings.criticalChanceToAttributeRatio
                * _gameManager.GameSettings.difficultyModifier;

        _characterStats.characterData.dodgeChance = _characterStats.characterData.baseAgility
            * _gameManager.GameSettings.dodgeChanceToAttributeRatio
                * _gameManager.GameSettings.difficultyModifier;

        _characterStats.characterData.baseDamage = _characterStats.characterData.baseStrength
        ...
        _characterStats.characterData.baseDefense = _characterStats.characterData.baseEndurance
            * _gameManager.GameSettings.defenseToAttributeRatio
                * _gameManager.GameSettings.difficultyModifier
                + _characterStats.characterData.baseStrength;
        ...
        _characterStats.characterData.M_E_FRegenerationAmount = _characterStats.characterData.baseStrength / 4
            * _gameManager.GameSettings.M_E_FRegenerationToAttributeRatio
                * _gameManager.GameSettings.difficultyModifier;

        _characterStats.characterData.maximumM_E_F = _characterStats.characterData.baseStrength
            * _gameManager.GameSettings.M_E_FToAttributeRatio
                * _gameManager.GameSettings.difficultyModifier;

        _characterStats.characterData.staminaRegenerationAmount = _characterStats.characterData.baseStrength
            * _gameManager.GameSettings.staminaRegenerationToAttributeRatio
                * _gameManager.GameSettings.difficultyModifier;

        _characterStats.characterData.maximumStamina = _characterStats.characterData.baseStrength
